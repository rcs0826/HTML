        ...
        return {
            ...
            link: function(scope, element, attrs, ganttCtrl) {
                ...
                api.directives.on.new(scope, function(directiveName, taskScope, taskElement) {
                    console.log("api.directives.on.new")
                ...
                api.tasks.on.clean(scope, function(model) {
                    console.log("api.tasks.on.clean")
        ...
        return {
            ...
            link: function(scope, element, attrs, ganttCtrl) {
                ...
                function buildSensors() {
                    console.log("function buildSensors()")
                    ...
                    var containerSensor = new ResizeSensor(ganttElement.parentElement, function() {
                        console.log("var containerSensor = new ResizeSensor")
        ...
        return {
            ...
            link: function(scope, element, attrs, ganttCtrl) {
                ...
                if (scope.headerContent === undefined) {
                    console.log("if (scope.headerContent === undefined) {")
...
(function() {
    ...
    angular.module('gantt.table').controller('TableColumnController', ['$scope', function($scope) {
        ...
        $scope.getHeaderContent = function() {
            console.log("$scope.getHeaderContent")
