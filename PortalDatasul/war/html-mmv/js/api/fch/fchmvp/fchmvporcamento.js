define(['index'], function(index) {
	...
	orcamentoFactory.$inject = ['$totvsresource'];
	function orcamentoFactory($totvsresource) {

		var factory = $totvsresource.REST('/dts/datasul-rest/resources/api/fch/fchmvp/fchmvporcamento/:method/:id', {}, {
			postArray: {
				method: 'POST',
				isArray: true
			},
	...
	index.register.factory('fchmvp.orcamento.Factory', orcamentoFactory);
});