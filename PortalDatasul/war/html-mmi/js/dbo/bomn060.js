define(['index'], function(index) { 
	...
	// *** FACTORIES
	// *************************************************************************************
	bomn060Factory.$inject = ['$totvsresource'];	
	function bomn060Factory($totvsresource) {
		
		// definimos uma nova factory a partir do totvsresource, passando a URL do serviço de DBO
		var factory = $totvsresource.REST('/dts/datasul-rest/resources/dbo/mnbo/bomn060//:id', {}, {});
	...
	index.register.factory('mmi.bomn060.Factory', bomn060Factory);
	
	// **************************************************************************************
	// *** SERVICE
	// **************************************************************************************
	
	bomn060Service.$inject = ['mmi.bomn060.Factory'];
	function bomn060Service(bomn060Factory) {
        ...
        this.findRecords = function (startAt, limitAt, parameters, callback) {
            ...
            return bomn060Factory.findRecords(parameters, callback);
        };
         
        this.getRecord = function (id, callback) {
            return bomn060Factory.getRecord(id, callback);
        };
         
        this.saveRecord = function (model, callback) {
            return bomn060Factory.saveRecord(model, callback);
        };
         
        this.updateRecord = function (id, model, callback) {
            return bomn060Factory.updateRecord(id, model, callback);
        };
         
        this.deleteRecord = function (id, callback) {
            return bomn060Factory.deleteRecord(id, callback);
        };
	}
	
	index.register.service('mmi.bomn060.Service', bomn060Service);
