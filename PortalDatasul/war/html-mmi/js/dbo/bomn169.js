define(['index'], function(index) { 
	...
	// *** FACTORIES
	// *************************************************************************************
	bomn169Factory.$inject = ['$totvsresource'];	
	function bomn169Factory($totvsresource) {
		
		// definimos uma nova factory a partir do totvsresource, passando a URL do serviço de DBO
		var factory = $totvsresource.REST('/dts/datasul-rest/resources/dbo/mnbo/bomn169//:pNrOrdProdu//:pCdTarefa//:pFiCodigo', {}, {}, {});
        ...
        factory.updateRecord = function (id, model, callback) {
        	return this.TOTVSUpdate({pNrOrdProdu: id.pNrOrdProdu, pCdTarefa: id.pCdTarefa, pFiCodigo: id.pFiCodigo}, model, callback);
            
        };
         
        factory.deleteRecord = function (id, callback) {
        	return this.TOTVSRemove({pNrOrdProdu: id.pNrOrdProdu, pCdTarefa: id.pCdTarefa, pFiCodigo: id.pFiCodigo}, callback);
        };
		
		return factory;
	}
	
	index.register.factory('mmi.bomn169.Factory', bomn169Factory);
	
	// **************************************************************************************
	// *** SERVICE
	// **************************************************************************************
	
	bomn169Service.$inject = ['mmi.bomn169.Factory'];
	function bomn169Service(bomn169Factory) {
        ...
        this.findRecords = function (startAt, limitAt, parameters, callback) {
            ...
            return bomn169Factory.findRecords(parameters, callback);
        };
         
        this.getRecord = function (id, callback) {
            return bomn169Factory.getRecord(id, callback);
        };
         
        this.saveRecord = function (model, callback) {
            return bomn169Factory.saveRecord(model, callback);
        };
         
        this.updateRecord = function (id, model, callback) {
            return bomn169Factory.updateRecord(id, model, callback);
        };
         
        this.deleteRecord = function (id, callback) {
            return bomn169Factory.deleteRecord(id, callback);
        };
	}
	
	index.register.service('mmi.bomn169.Service', bomn169Service);
