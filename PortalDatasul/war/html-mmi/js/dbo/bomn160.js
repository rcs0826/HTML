define(['index'], function(index) { 
    ...
    // *** FACTORIES
    // *************************************************************************************
    bomn160Factory.$inject = ['$totvsresource'];    
    function bomn160Factory($totvsresource) {
        
        // definimos uma nova factory a partir do totvsresource, passando a URL do serviço de DBO
        var factory = $totvsresource.REST('/dts/datasul-rest/resources/dbo/mnbo/bomn160//:pCdTpFerr', {}, {});
        ...
        factory.getRecord = function (id, callback) {
            return this.TOTVSGet({pCdTpFerr: id.pCdTpFerr}, callback, {noErrorMessage:true});
        };
        ...
        factory.updateRecord = function (id, model, callback) {
            return this.TOTVSUpdate({ pCdTpFerr: id.pCdTpFerr}, model, callback);
        };
         
        factory.deleteRecord = function (id, callback) {
            return this.TOTVSRemove({pCdTpFerr: id.pCdTpFerr}, callback);
        };
        
        return factory;
    }
    
    index.register.factory('mmi.bomn160.Factory', bomn160Factory);
    
    // **************************************************************************************
    // *** SERVICE
    // **************************************************************************************
    
    bomn160Service.$inject = ['mmi.bomn160.Factory'];
    function bomn160Service(bomn160Factory) {
        ...
        this.findRecords = function (startAt, limitAt, parameters, callback) {
            ...
            return bomn160Factory.findRecords(parameters, callback);
        };
         
        this.getRecord = function (id, callback) {
            return bomn160Factory.getRecord(id, callback);
        };
         
        this.saveRecord = function (model, callback) {
            return bomn160Factory.saveRecord(model, callback);
        };
         
        this.updateRecord = function (id, model, callback) {
            return bomn160Factory.updateRecord(id, model, callback);
        };
         
        this.deleteRecord = function (id, callback) {
            return bomn160Factory.deleteRecord(id, callback);
        };
    }
    
    index.register.service('mmi.bomn160.Service', bomn160Service);
