define(['index'], function(index) { 
	...
	// *** FACTORIES
	// *************************************************************************************
	bomn134Factory.$inject = ['$totvsresource'];	
	function bomn134Factory($totvsresource) {
		
		// definimos uma nova factory a partir do totvsresource, passando a URL do serviço de DBO
		var factory = $totvsresource.REST('/dts/datasul-rest/resources/dbo/mnbo/bomn134html//:id', {}, {});
	...
	index.register.factory('mmi.bomn134.Factory', bomn134Factory);
	
	// **************************************************************************************
	// *** SERVICE
	// **************************************************************************************
	
	bomn134Service.$inject = ['mmi.bomn134.Factory'];
	function bomn134Service(bomn134Factory) {
        ...
        this.findRecords = function (startAt, limitAt, parameters, callback) {
            ...
            return bomn134Factory.findRecords(parameters, callback);
        };
         
        this.getRecord = function (id, callback) {
            return bomn134Factory.getRecord(id, callback);
        };
         
        this.saveRecord = function (model, callback) {
            return bomn134Factory.saveRecord(model, callback);
        };
         
        this.updateRecord = function (id, model, callback) {
            return bomn134Factory.updateRecord(id, model, callback);
        };
         
        this.deleteRecord = function (id, callback) {
            return bomn134Factory.deleteRecord(id, callback);
        };
	}
	
	index.register.service('mmi.bomn134.Service', bomn134Service);
