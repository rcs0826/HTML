define(['index'], function(index) {
	...
	// *** FACTORIES
	// *************************************************************************************
	bomn258Factory.$inject = ['$totvsresource'];	
	function bomn258Factory($totvsresource) {
		
		// definimos uma nova factory a partir do totvsresource, passando a URL do serviço de DBO
		var factory = $totvsresource.REST('/dts/datasul-rest/resources/dbo/mnbo/bomn258//:id', {}, {});
	...
	index.register.factory('mmi.bomn258.Factory', bomn258Factory);
	
	// **************************************************************************************
	// *** SERVICE
	// **************************************************************************************
	
	bomn258Service.$inject = ['mmi.bomn258.Factory'];
	function bomn258Service(bomn258Factory) {
        ...
        this.findRecords = function (startAt, limitAt, parameters, callback) {
            ...
            return bomn258Factory.findRecords(parameters, callback);
        };
         
        this.getRecord = function (id, callback) {
            return bomn258Factory.getRecord(id, callback);
        };
         
        this.saveRecord = function (model, callback) {
            return bomn258Factory.saveRecord(model, callback);
        };
         
        this.updateRecord = function (id, model, callback) {
            return bomn258Factory.updateRecord(id, model, callback);
        };
         
        this.deleteRecord = function (id, callback) {
            return bomn258Factory.deleteRecord(id, callback);
        };
	}
	
	index.register.service('mmi.bomn258.Service', bomn258Service);
