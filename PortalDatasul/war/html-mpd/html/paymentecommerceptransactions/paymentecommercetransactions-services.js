define([
    ...
    paymentecommerceTransactionsController.$inject = [
        '$scope',
        '$rootScope',           
    ...
    function paymentecommerceTransactionsController($scope, $rootScope, appViewService, pedpagtoservice, customizationService, $stateParams, TOTVSEvent, $modal, $filter) {
        ...
        this.openAdvancedSearch = function() {
            var modalInstance = $modal.open({
              templateUrl: '/dts/mpd/html/paymentecommercetransactions/paymentecommercetransactions.search.html',
              controller: 'mpd.paymentecommercetransactionsadvanced.Control as controller',
              size: 'lg',
              resolve: {
                model: function () {
        ...
        // *********************************************************************************
        this.init = function() {           
            if (appViewService.startView($rootScope.i18n('l-payment-e-commerce'), 'mpd.paymentecommercetransactions.list.control', controller)) {
    ...
    paymentecommerceTransDetailController.$inject = ['$rootScope', 
                                                   '$scope', 
                                                   '$stateParams', 
                                                   '$state',
                                                   'totvs.app-main-view.Service', 
                                                   'mpd.pedpagto.Service',
                                                   'TOTVSEvent'];    
    function paymentecommerceTransDetailController($rootScope, $scope, $stateParams, $state,appViewService, pedpagtoservice, TOTVSEvent) {
        ...
        this.init = function() {
            if (appViewService.startView($rootScope.i18n('Detalhes do Pedido'), 'mpd.paymentecommercetransactions.detail.Control', controller)) {             
                // se é a abertura da tab, implementar aqui inicialização do controller
            }
    ...
    paymentecommerceTransAdvancedController.$inject = ['$modalInstance', 'model'];
    function paymentecommerceTransAdvancedController ($modalInstance, model) {
         
...
    }
    ...
    index.register.controller('mpd.paymentecommercetransactions.list.control'    , paymentecommerceTransactionsController);
    index.register.controller('mpd.paymentecommercetransactionsadvanced.Control' , paymentecommerceTransAdvancedController);
    index.register.controller('mpd.paymentecommercetransactions.detail.Control'  , paymentecommerceTransDetailController);
