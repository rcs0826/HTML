...
define(['index'], function(index) {
    ...
    function modalStockController(fchdis0051, modalParams, $modalInstance, $modal) {
        ...
        modalStockController.openParameters = function () {
            var modalInstance = $modal.open({
                templateUrl: '/dts/mpd/html/order2/itemSearch.stock.params.html',
                controller: 'salesorder.itemsearchStockParams.Controller as stockParamsController',
                size: 'lg',
                resolve: {
    ...
    index.register.controller('salesorder.itemsearch.stock.Controller', modalStockController);
