	...
	function modalItemcontroller(
				...
				if (item) {
					fchdis0063.leaveOrderItem({
						...
						if (reloadDiscountsItem) {
							itemController.item["val-pct-desconto-prazo"] = result.ttOrderItemPortalScreen[0]["val-pct-desconto-prazo"];
							itemController.item["val-pct-desconto-periodo"] = result.ttOrderItemPortalScreen[0]["val-pct-desconto-periodo"];
							itemController.item["val-desconto"][0] = result.ttOrderItemPortalScreen[0]["val-desconto"][0];
							itemController.item["val-desconto"][1] = result.ttOrderItemPortalScreen[0]["val-desconto"][1];
							itemController.item["val-desconto"][2] = result.ttOrderItemPortalScreen[0]["val-desconto"][2];
							itemController.item["val-desconto"][3] = result.ttOrderItemPortalScreen[0]["val-desconto"][3];
							itemController.item["val-desconto"][4] = result.ttOrderItemPortalScreen[0]["val-desconto"][4];
						} else {
							itemController.item = result.ttOrderItemPortalScreen[0];
						}
		...
		itemController.saveItem = function(fechar) {
			...
			fchdis0063.saveOrderItem({
				...
				if (!result.$hasError) {
					if (
						result.ttOrderItemPortalScreen[0]['char-2'].substr(89, 3) == 'yes' &&
