...
    
    ...
    serviceZoomMotivoCancelamento.$inject = ['$timeout', '$totvsresource'];

    function serviceZoomMotivoCancelamento($timeout, $totvsresource){
	...
	var service = {
            ...
            getObjectFromValue: function (value) {
                if (value)
                    return this.resource.TOTVSGet({codMotivo: value, indTpTrans: 1}, undefined , {noErrorMessage: true}, true);
            },
    ...
    index.register.service('mpd.motivoCancelamento.Zoom', serviceZoomMotivoCancelamento);
