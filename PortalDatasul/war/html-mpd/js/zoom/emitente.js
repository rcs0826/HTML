define(['index',
	...
	serviceEmitente.$inject = ['$timeout', '$totvsresource', '$rootScope', '$filter', 'dts-utils.zoom', 'dts-utils.utils.Service', '$q'];
	function serviceEmitente($timeout, $totvsresource, $rootScope, $filter, zoomService, dtsUtils, $q) {
		...
		service.getObjectFromValue =  function (value) {
            var itemSelected,
            queryproperties = {where: ["emitente.cod-emitente = INTEGER(" +  value + ")"]},
            getItem = function (item){
                if (item['cod-emitente'] == value) return item;
            };
