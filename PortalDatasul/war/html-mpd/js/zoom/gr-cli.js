define(['index',
	...
	function serviceGrupoClienteZoom($timeout, $totvsresource, $rootScope, $filter, zoomService, dtsUtils) {
		...
		service.propertyFields = [
			...
			{label: 'l-carrier', property: 'portador', type:'integerrange'},
		...
		service.columnDefs = [
			...
			{headerName: $rootScope.i18n('l-permission', undefined, 'dts/mpd'), field: 'permissao'},
			{headerName: $rootScope.i18n('l-cdn-cond-pag', undefined, 'dts/mpd'), field: 'cod-cond-pag'},
			{headerName: $rootScope.i18n('l-linha-produt', undefined, 'dts/mpd'), field: 'linha-produt'},
			{headerName: $rootScope.i18n('l-delay-days', undefined, 'dts/mpd'), field: 'nr-dias-atraso'},
			{headerName: $rootScope.i18n('l-natureza', undefined, 'dts/mpd'), field: 'natureza'},
			...
			{headerName: $rootScope.i18n('l-price-table', undefined, 'dts/mpd'), field: 'nr-tabpre'},
			{headerName: $rootScope.i18n('l-tp-preco', undefined, 'dts/mpd'), field: 'tp-rec-desp'},
			{headerName: $rootScope.i18n('l-cdn-cond-pag', undefined, 'dts/mpd'), field: 'cod-cond-pag'}];
