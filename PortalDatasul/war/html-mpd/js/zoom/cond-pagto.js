define(['index',
	...
	function serviceCondPagto($timeout, $totvsresource, $rootScope, $filter, zoomService, dtsUtils, fchdisdbo) {
		...
		service.resource = $totvsresource.REST(
			'/dts/datasul-rest/resources/dbo/adbo/boad039pv/:method/:gotomethod/:id',
			{ fields: "cod-cond-pag,descricao,log-cond-pagto-mais-negoc" },
			{ }
		);
	...
	index.register.service('mpd.cond-pagto.zoom', serviceCondPagto);
