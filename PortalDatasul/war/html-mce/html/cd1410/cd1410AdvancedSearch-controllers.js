define(['index'], function (index) {
    ...
    cd1410CtrlAdvacedSearch.$inject = [
   '$rootScope', '$scope', '$modalInstance', 'parameters', 'mce.utils.Service', '$filter', 'TOTVSEvent'
   ];



    function cd1410CtrlAdvacedSearch($rootScope, $scope, $modalInstance, parameters, mceUtils, $filter, TOTVSEvent) {
    ...
    index.register.controller('mce.cd1410.AdvacendSearch', cd1410CtrlAdvacedSearch);
});
