define([
    'index',
    '/dts/mce/html/ce0205a/ce0205a-controllers.js' 
    ], function(index) {
    ...
    index.stateProvider
        ...
        .state('dts/mce/ce0205a.start', {
            url: '/dts/mce/ce0205a/?site&itemCode&warehouse',
            controller: 'mce.ce0205a.EditCtrl',
            controllerAs: 'controller',
            templateUrl: '/dts/mce/html/ce0205a/ce0205a.edit.html'
        })  
});