define([
    'index',
    '/dts/mce/html/ce0830/ce0830-controller.js'
    ], function(index) {
 
    // Inicializa os states da aplicação. 'dts/mce/html/ce0830/ce0830-services.js'
    index.stateProvider
        ...
        .state('dts/mce/ce0830.start', {
            url: '/dts/mce/ce0830/?site&itemCode&warehouse',
            controller: 'mce.ce0830.ListController',
            controllerAs: 'controller',
            templateUrl: '/dts/mce/html/ce0830/ce0830.list.html'
        })       
});