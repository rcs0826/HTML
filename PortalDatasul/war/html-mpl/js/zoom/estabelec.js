define(['index', '/dts/dts-utils/js/zoom/zoom.js', '/dts/dts-utils/js/dts-utils.js'], function (index) {
    ...
    function serviceZoomEstabelecimento($rootScope, $timeout, $totvsresource, dtsUtils, zoomService) {
        ...
        service.zoomName = $rootScope.i18n('l-site', undefined, 'dts/mpl');
        ...
        service.propertyFields = [{
                label: $rootScope.i18n('l-code', undefined, 'dts/mpl'),
            ...
            {
                label: $rootScope.i18n('l-name', undefined, 'dts/mpl'),
                property: 'nome',
                type: 'stringextend',
                maxlength:40
            },
            {
                label: $rootScope.i18n('l-city', undefined, 'dts/mpl'),
                property: 'cidade',
                type: 'stringextend',
                maxlength:25
            },
            {
                label: $rootScope.i18n('l-uf', undefined, 'dts/mpl'),
                property: 'estado',
                type: 'stringextend',
                maxlength:4
        }];
        ...
        service.columnDefs = [
            {
                headerName: $rootScope.i18n('l-code', undefined, 'dts/mpl'),
                field: 'cod-estabel',
                width: 100,
                minWidth: 80
            ...
            {
                headerName: $rootScope.i18n('l-name', undefined, 'dts/mpl'),
                field: 'nome',
                width: 350,
                minWidth: 150
            },
            {
                headerName: $rootScope.i18n('l-city', undefined, 'dts/mpl'),
                field: 'cidade',
                width: 250,
                minWidth: 100
            },
            {
                headerName: $rootScope.i18n('l-uf', undefined, 'dts/mpl'),
                field: 'estado',
                width: 150,
                minWidth: 50
            ...
            {
                headerName: $rootScope.i18n('l-company', undefined, 'dts/mpl'),
                field: 'ep-codigo',
                width: 100,
                minWidth: 80
        }];
    ...
    serviceZoomEstabelecimentoSE.$inject = ['mpd.estabelec.zoom','$totvsresource'];
