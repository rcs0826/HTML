...
define(['index',
    ...
    '/dts/dts-utils/js/dts-utils.js'], function (index) {
        ...
        /*####################################################################################################
         # Database: emsuni
         # Table...: espec_docto
         # Service.: serviceDocClass
         # Register: acr.espec-docto.zoom
         ####################################################################################################*/
        function serviceDocClass($timeout,
            ...
            service.zoomName = $rootScope.i18n('l-doc-class', undefined, 'dts/acr');
            service.setConfiguration('acr.espec-docto.zoom');
            ...
            service.propertyFields = [
                ...
                {
                    label: $rootScope.i18n('l-document-class', undefined, 'dts/acr'),
            ...
            service.columnDefs = [
                ...
                {
                    headerName: $rootScope.i18n('l-document-class', undefined, 'dts/acr'),
                    ...
                    headerName: $rootScope.i18n('l-class-type', undefined, 'dts/acr'),
        ...
        index.register.service('acr.espec-docto.zoom', serviceDocClass);
