...
define(['index',
    ...
    /*####################################################################################################
     # Database: emsuni
     # Table...: ser_fisc_nota
     # Service.: serviceFinancialDocSeries
     # Register: acr.ser-fisc-nota.zoom
     ####################################################################################################*/
    function serviceFinancialDocSeries($timeout,
        ...
        service.zoomName       = $rootScope.i18n('l-invoice-series', undefined, 'dts/acr');
        service.setConfiguration('acr.ser-fisc-nota.zoom');
        ...
        service.propertyFields = [
            ...
            {
                label: $rootScope.i18n('l-tax-invoice-series', undefined, 'dts/acr'),
        ...
        service.columnDefs = [
            ...
            {
                headerName: $rootScope.i18n('l-tax-invoice-series', undefined, 'dts/acr'), // Estabelecimento
                field: 'cod_ser_fisc_nota',
                width: 100,
                minWidth: 100
            }, {
                headerName: $rootScope.i18n('l-description', undefined, 'dts/acr'), // Estabelecimento
    ...
    index.register.service('acr.ser-fisc-nota.zoom', serviceFinancialDocSeries);
