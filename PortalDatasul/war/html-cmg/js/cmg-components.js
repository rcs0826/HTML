/*globals angular, define, CMGUtil, kendo */
...
define([
	...
	index.register.directive('cmgTotvsWidgetHeader', ['$window', function ($window) {
	...
	index.register.directive('cmgTotvsWidgetFooterActions', [function () {
					...
					actionsTemplate = angular.element(
						'<span class="pull-right dropup">' +
							'<span class="widget-details clickable dropdown-toggle" id="widget-detail-dropdown" ' +
								...
								'<a class="cliclable" role="button">{{ "nav-action" | i18n : [] : "dts/cmg/" }}&nbsp;' +
	...
	index.register.directive('cmgTotvsChart', function () {

		var directive = {
			template: '<div kendo-chart class="cmg-totvs-chart" k-options="chart"></div>' +
