define(['index', 
	...
	dashboardKeepTrackOfBalancesByCompanyCtrl.$inject = ['$rootScope', '$filter', 'cmg.keeptrackofbalances.Factory', 'TOTVSEvent'];

	function dashboardKeepTrackOfBalancesByCompanyCtrl($rootScope, $filter, service, TOTVSEvent) {
        ...
        controller.tamDiv = document.getElementById('keeptrackofbalancesbycompany_div').offsetWidth;
        ...
        controller.loadData = function() {
            ...
            service.getBalancesByCompany( function(result){
                if (result) {

                    angular.forEach(result, function (value) {
                        controller.listOfCompanies.push(value);
	...
	}//function dashboardKeepTrackOfBalancesByCompanyCtrl(loadedModules, userMessages)

	index.register.controller('cmg.dashboard.keeptrackofbalancesbycompany.Controller', dashboardKeepTrackOfBalancesByCompanyCtrl);
});