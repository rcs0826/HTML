define(['index', 
	...
	dashboardKeepTrackOfBalancesByUFCCtrl.$inject = ['$rootScope', '$filter', 'cmg.keeptrackofbalances.Factory', 'TOTVSEvent'];

	function dashboardKeepTrackOfBalancesByUFCCtrl($rootScope, $filter, service, TOTVSEvent) {
        ...
        controller.tamDiv = document.getElementById('keeptrackofbalancesbyufc_div').offsetWidth;
        ...
        controller.loadData = function() {
            ...
            service.getBalancesByUFC( function(result){
                if (result) {

                    angular.forEach(result, function (value) {
                        controller.listOfUFCs.push(value);
        ...
        this.createData = function (result) {
            ...
            for (i = 0; i < result.length; i += 1) {
                ...
                controller.categories.push(result[i].ufcDescription);
	...
	}//function dashboardKeepTrackOfBalancesByUFCCtrl(loadedModules, userMessages)

	index.register.controller('cmg.dashboard.keeptrackofbalancesbyufc.Controller', dashboardKeepTrackOfBalancesByUFCCtrl);
});