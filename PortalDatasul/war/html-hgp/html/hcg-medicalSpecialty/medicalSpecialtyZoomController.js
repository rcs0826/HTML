define(['index',
	...
	function medicalSpecialtyZoomController($injector, $totvsresource, zoomService, dtsUtils) {
        ...
        service.setConfiguration('hcg.medicalSpecialtyZoomController');
        service.idSearchMethod = 'getMedicalSpecialtyByZoomId';
        service.applyFilterMethod = 'getMedicalSpecialitiesForZoom';
    ...
    index.register.factory('hcg.medicalSpecialtyZoomController', medicalSpecialtyZoomController);
