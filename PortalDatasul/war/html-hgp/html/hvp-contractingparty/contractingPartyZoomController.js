define(['index',
	...
	contractingPartyZoomController.$inject = ['$injector', '$totvsresource', 'dts-utils.zoom', 'dts-utils.utils.Service'];
	function contractingPartyZoomController($injector, $totvsresource, zoomService, dtsUtils) {
        ...
        service.setConfiguration('hvp.contractingPartyZoomController');
        service.idSearchMethod = 'getContractingPartyByZoomId';
        service.applyFilterMethod = 'getContractingPartyForZoom';
