...
Date.getAgeLabel = function(dateMilliseconds){
	var today = new Date();
    var birthDate = new Date(dateMilliseconds);
...
Date.milisToProgress = function(milis){
    return milis + 43200000; //adiciona 12 horas
};