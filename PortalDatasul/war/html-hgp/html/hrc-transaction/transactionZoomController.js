define(['index',
    ...
    function transactionZoomController($injector, $totvsresource, zoomService, dtsUtils) {
        ...
        service.zoomName       = 'Transação';
        service.setConfiguration('hrc.transactionZoomController');
    ...
    index.register.factory('hrc.transactionZoomController', transactionZoomController);
