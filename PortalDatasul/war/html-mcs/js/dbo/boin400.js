define(['index'], function(index) {
	...
	// *** FACTORIES
	// *************************************************************************************
	boin400Factory.$inject = ['$totvsresource'];	
	function boin400Factory($totvsresource) {
		
		// definimos uma nova factory a partir do totvsresource, passando a URL do serviço de DBO
		var factory = $totvsresource.REST('/dts/datasul-rest/resources/dbo/inbo/boin400//:id', {}, {});
	...
	index.register.factory('mcs.boin400.Factory', boin400Factory);
	
	// **************************************************************************************
	// *** SERVICE
	// **************************************************************************************
	
	boin400Service.$inject = ['mcs.boin400.Factory'];
	function boin400Service(boin400Factory) {
        ...
        this.findRecords = function (startAt,limitAt, parameters, callback) {
            ...
            return boin400Factory.findRecords(parameters, callback);
        };
         
        this.getRecord = function (id, callback) {
            return boin400Factory.getRecord(id, callback);
        };
         
        this.saveRecord = function (model, callback) {
            return boin400Factory.saveRecord(model, callback);
        };
         
        this.updateRecord = function (id, model, callback) {
            return boin400Factory.updateRecord(id, model, callback);
        };
         
        this.deleteRecord = function (id, callback) {
            return boin400Factory.deleteRecord(id, callback);
        };
	}
	
	index.register.service('mcs.boin400.Service', boin400Service);
