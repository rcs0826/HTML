define(['index', '/dts/dts-utils/js/zoom/zoom.js', '/dts/dts-utils/js/dts-utils.js'], function (index) {
    ...
    function serviceZoomEstabelecimento($rootScope, $timeout, $totvsresource, dtsUtils, zoomService) {
        ...
        service.zoomName = $rootScope.i18n('l-site', undefined, 'dts/mcs');
        ...
        service.propertyFields = [{
                label: $rootScope.i18n('l-code', undefined, 'dts/mcs'),
            ...
            {
                label: $rootScope.i18n('l-name', undefined, 'dts/mcs'),
                property: 'nome',
                type: 'stringextend',
                maxlength:40
            },
            {
                label: $rootScope.i18n('l-city', undefined, 'dts/mcs'),
                property: 'cidade',
                type: 'stringextend',
                maxlength:25
            },
            {
                label: $rootScope.i18n('l-uf', undefined, 'dts/mcs'),
                property: 'estado',
                type: 'stringextend',
                maxlength:4
        }];
        ...
        service.columnDefs = [
            {
                headerName: $rootScope.i18n('l-code', undefined, 'dts/mcs'),
                field: 'cod-estabel',
                width: 100,
                minWidth: 80
            ...
            {
                headerName: $rootScope.i18n('l-name', undefined, 'dts/mcs'),
                field: 'nome',
                width: 350,
                minWidth: 150
            },
            {
                headerName: $rootScope.i18n('l-city', undefined, 'dts/mcs'),
                field: 'cidade',
                width: 250,
                minWidth: 100
            },
            {
                headerName: $rootScope.i18n('l-uf', undefined, 'dts/mcs'),
                field: 'estado',
                width: 150,
                minWidth: 50
            ...
            {
                headerName: $rootScope.i18n('l-company', undefined, 'dts/mcs'),
                field: 'ep-codigo',
                width: 100,
                minWidth: 80
        }];
