/*globals angular, define, CFLUtil, kendo */
...
define([
	...
	index.register.directive('cflTotvsWidgetHeader', ['$window', function ($window) {
	...
	index.register.directive('cflTotvsWidgetFooterActions', [function () {
					...
					actionsTemplate = angular.element(
						'<span class="pull-right dropup">' +
							'<span class="widget-details clickable dropdown-toggle" id="widget-detail-dropdown" ' +
								...
								'<a class="cliclable" role="button">{{ "nav-action" | i18n : [] : "dts/cfl/" }}&nbsp;' +
	...
	index.register.directive('cflTotvsChart', function () {

		var directive = {
			template: '<div kendo-chart class="cfl-totvs-chart" k-options="chart"></div>' +
