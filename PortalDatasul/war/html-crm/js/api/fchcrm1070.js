...
define([
	...
	factory = function ($totvsresource, $cacheFactory, factoryGeneric, factoryGenericCreateUpdate,
		...
		var cache = $cacheFactory('crm.acao.Cache'),
			factory = $totvsresource.REST(CRMRestService + '1070/:method/:id', undefined,
	...
	index.register.factory('crm.crm_acao.factory', factory);
