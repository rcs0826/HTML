...
define([
	...
	factory = function ($totvsresource, $cacheFactory, factoryGeneric, factoryGenericCreateUpdate,
		...
		var cache = $cacheFactory('crm.mid.Cache'),
			factory = $totvsresource.REST(CRMRestService + '1072/:method/:id', undefined,
		...
		factory.findRecords = function (parameters, options, callback) {
			...
			options.orderBy	= ['nom_mid_relacto'];
			options.asc		= [true];
	...
	index.register.factory('crm.crm_mid.factory', factory);
