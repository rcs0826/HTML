...
define([
	...
	factory = function ($totvsresource, $cacheFactory, factoryGeneric, factoryGenericCreateUpdate,
		...
		var cache = $cacheFactory('crm.tip.campaign.Cache'),
			factory = $totvsresource.REST(CRMRestService + '1069/:method/:id', undefined,
		...
		factory.findRecords = function (parameters, options, callback) {
			...
			options.orderBy	= ['nom_tip_campanha'];
			options.asc		= [true];
	...
	index.register.factory('crm.crm_tip_campanha.factory', factory);
