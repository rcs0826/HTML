...
define([
	...
	factory = function ($totvsresource, $cacheFactory, factoryGeneric, factoryGenericCreateUpdate,
		...
		var cache = $cacheFactory('crm.detmnto.Cache'),
			factory = $totvsresource.REST(CRMRestService + '1074/:method/:id', undefined,
		...
		factory.findRecords = function (parameters, options, callback) {
			...
			options.orderBy	= ['nom_detmnto_restdo'];
			options.asc		= [true];
	...
	index.register.factory('crm.crm_detmnto.factory', factory);
