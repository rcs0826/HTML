...
define([
	...
	factoryCfop = function ($totvsresource, $cacheFactory, factoryGeneric,
						 factoryGenericZoom, factoryGenericTypeahead) {

		var cache = $cacheFactory('crm_cfop.Cache'),
			factory = $totvsresource.REST(CRMURL.cfopService + ':method/:id');
	...
	index.register.factory('crm.crm_erp_natur_operac.factory', factoryCfop);
