...
define([
	...
	factory = function ($totvsresource, $cacheFactory, factoryGeneric, factoryGenericCreateUpdate, factoryGenericDetail, factoryGenericDelete) {
		...
		var cache = $cacheFactory('crm.tip.anexo.Cache'),
			factory = $totvsresource.REST(CRMRestService + '1092/:method/:id', undefined, factoryGenericCreateUpdate.customActions);
	...
	index.register.factory('crm.crm_tip_anexo.factory', factory);
