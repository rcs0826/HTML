...
define([
	...
	var factoryDecisionLevel;

	factoryDecisionLevel = function ($totvsresource, $cacheFactory, factoryGeneric,
								  factoryGenericZoom, factoryGenericTypeahead) {

		var cache = $cacheFactory('crm.decisionLevel.Cache'),
			factory = $totvsresource.REST(CRMURL.decisionLevelService + ':method/:id');
		...
		return factory;
	}; // factoryDecisionLevel
	factoryDecisionLevel.$inject = [
	...
	index.register.factory('crm.crm_niv_decis.factory',	factoryDecisionLevel);
