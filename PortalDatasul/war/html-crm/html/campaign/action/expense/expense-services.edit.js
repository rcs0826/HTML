...
define([
    ...
    modal = function ($modal) {
        this.open = function (params) {
			var instance = $modal.open({
				templateUrl: '/dts/crm/html/campaign/action/expense/expense.edit.html',
				controller: 'crm.crm_acao_tip_despes.edit.control as controller',
				backdrop: 'static',
				keyboard: false,
				size: 'lg',
    ...
    controller = function ($rootScope, $scope, $location, $modalInstance, parameters, fchcrm1082, fchcrm1114, helper, fchcrm1001) {
        ...
        this.save = function (isSaveAndNew) {
            ...
            if (CRMControl.editMode === true) {
				fchcrm1001.updateActionExpense(CRMControl.campaignActionId, vo.num_id, vo, function (result) {
				...
				fchcrm1001.saveActionExpense(CRMControl.campaignActionId, vo, function (result) {
                    if (result && result.length > 0) {
                        CRMControl.resultList.push(result[0]);
        ...
        this.convertToSave = function () {
            ...
            vo = {
                ...
                num_id_campanha_acao: CRMControl.campaignActionId,
        ...
        this.campaignActionId = parameters.campaignActionId;
	...
	index.register.service('crm.crm_acao_tip_despes.modal.edit', modal);
	index.register.controller('crm.crm_acao_tip_despes.edit.control', controller);
});
