...
define([
	...
	controller = function ($scope, $rootScope, TOTVSEvent, helper, factory, modalEdit, userPreferenceModal) {
		...
		this.remove = function (item) {
			...
			$rootScope.$broadcast(TOTVSEvent.showQuestion, {
				...
				text: $rootScope.i18n('msg-confirm-delete', [
					$rootScope.i18n('nav-generic-action-setting', [], 'dts/crm').toLowerCase(), item.nom_configur
				], 'dts/crm'),
		...
		this.userSettings = function () {
			userPreferenceModal.open({ context: 'generic-action-setting.list' });
		};
		...
		this.init = function init() {
			...
			var viewName = $rootScope.i18n('nav-generic-action-setting', [], 'dts/crm'),
				viewController = 'crm.generic-action-setting.list.control';
	...
	controller.$inject = [
		'$scope', '$rootScope', 'TOTVSEvent', 'crm.helper', 'crm.crm_configur_acao_ocor.factory',
		'crm.generic-action-setting.modal.edit', 'crm.user.modal.preference'
	];
	...
	index.register.controller('crm.generic-action-setting.list.control', controller);
});
