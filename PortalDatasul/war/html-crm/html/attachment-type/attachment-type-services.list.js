...
define([
	...
	controller = function ($scope, $rootScope, TOTVSEvent, helper, factory, modalEdit, userPreferenceModal) {
		...
		this.remove = function (item) {
			...
			$rootScope.$broadcast(TOTVSEvent.showQuestion, {
				...
				text: $rootScope.i18n('msg-confirm-delete', [
					$rootScope.i18n('nav-attachment-type', [], 'dts/crm').toLowerCase(), item.nom_tip_anexo
				], 'dts/crm'),
				callback: function (isPositiveResult) {
					...
					factory.deleteRecord(item.num_id, function (result) {
						...
						$rootScope.$broadcast(TOTVSEvent.showNotification, {
							type: 'success',
							title: $rootScope.i18n('nav-attachment-type', [], 'dts/crm'),
		...
		this.userSettings = function () {
			userPreferenceModal.open({ context: 'attachment-type.list' });
		};
		...
		this.init = function init() {
			...
			var viewName = $rootScope.i18n('nav-attachment-type', [], 'dts/crm'),
				viewController = 'crm.attachment-type.list.control';
	...
	controller.$inject = [
		'$scope', '$rootScope', 'TOTVSEvent', 'crm.helper', 'crm.crm_tip_anexo.factory',
		'crm.attachment-type.modal.edit', 'crm.user.modal.preference'
	];
	...
	index.register.controller('crm.attachment-type.list.control', controller);
});
