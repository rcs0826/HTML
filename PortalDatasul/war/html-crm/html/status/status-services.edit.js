...
define([
    ...
    modal = function ($modal) {
        this.open = function (params) {
            var instance = $modal.open({
                templateUrl: '/dts/crm/html/status/status.edit.html',
                controller: 'crm.status.edit.control as controller',
                backdrop: 'static',
                keyboard: false,
    ...
    controller = function ($rootScope, $scope, $modalInstance, parameters, TOTVSEvent,
        ...
        this.save = function (isToContinue) {
            ...
            fnAfterSave = function (item) {
                ...
                $rootScope.$broadcast(TOTVSEvent.showNotification, {
                    type: 'success',
                    title: $rootScope.i18n('l-status', [], 'dts/crm'),
                    detail: $rootScope.i18n(message, [
                        $rootScope.i18n('l-status', [], 'dts/crm'),
        ...
        this.isInvalidForm = function () {
            ...
            if (!model.nom_status_ocor || model.nom_status_ocor.trim().length === 0) {
                isInvalidForm = true;
                messages.push('l-name');
            }

            if (isInvalidForm) {
                helper.showInvalidFormMessage('l-status', messages);
            }
        ...
        this.convertToSave = function () {
            ...
            vo.nom_status_ocor = model.nom_status_ocor;
    ...
    index.register.service('crm.status.modal.edit', modal);
    index.register.controller('crm.status.edit.control', controller);
});
