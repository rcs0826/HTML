define(['index', '/dts/dts-utils/js/zoom/zoom.js', '/dts/dts-utils/js/dts-utils.js'], function (index) {
    ...
    function serviceZoomEstabelecimento($rootScope, $timeout, $totvsresource, dtsUtils, zoomService) {
        ...
        service.zoomName = $rootScope.i18n('l-estabel', undefined, 'dts/mcp');
        ...
        service.propertyFields = [{
            ...
            {
                label: $rootScope.i18n('l-nome', undefined, 'dts/mcp'),
                property: 'nome',
                type: 'stringextend',
                maxlength:40
            },
            {
                label: $rootScope.i18n('l-cidade', undefined, 'dts/mcp'),
                property: 'cidade',
                type: 'stringextend',
                maxlength:25
            },
            {
                label: $rootScope.i18n('l-estado', undefined, 'dts/mcp'),
                property: 'estado',
                type: 'stringextend',
                maxlength:4
            }];
        ...
        service.columnDefs = [
            {
                headerName: $rootScope.i18n('l-code', undefined, 'dts/mcp'),
                field: 'cod-estabel',
                width: 100,
                minWidth: 80
            ...
            {
                headerName: $rootScope.i18n('l-nome', undefined, 'dts/mcp'),
                field: 'nome',
                width: 350,
                minWidth: 150
            },
            {
                headerName: $rootScope.i18n('l-cidade', undefined, 'dts/mcp'),
                field: 'cidade',
                width: 250,
                minWidth: 100
            },
            {
                headerName: $rootScope.i18n('l-estado', undefined, 'dts/mcp'),
                field: 'estado',
                width: 150,
                minWidth: 50
    ...
    index.register.service('mcp.estabelec.zoom', serviceZoomEstabelecimento);
    index.register.service('mcp.estabelec.select', serviceZoomEstabelecimento);
	
    serviceZoomEstabelecimentoSE.$inject = ['mcp.estabelec.zoom','$totvsresource'];
    ...
    index.register.service('mcp.estabelecSE.zoom', serviceZoomEstabelecimentoSE);
    index.register.service('mcp.estabelecSE.select', serviceZoomEstabelecimentoSE);
