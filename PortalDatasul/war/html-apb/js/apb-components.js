/*globals angular, define, APBUtil, kendo */
...
define([
	...
	index.register.directive('apbTotvsWidgetHeader', ['$window', function ($window) {
	...
	index.register.directive('apbTotvsWidgetFooterActions', [function () {
					...
					actionsTemplate = angular.element(
						'<span class="pull-right dropup">' +
							'<span class="widget-details clickable dropdown-toggle" id="widget-detail-dropdown" ' +
								...
								'<a class="cliclable" role="button">{{ "nav-action" | i18n : [] : "dts/apb/" }}&nbsp;' +
	...
	index.register.directive('apbTotvsChart', function () {

		var directive = {
			template: '<div kendo-chart class="apb-totvs-chart" k-options="chart"></div>' +
