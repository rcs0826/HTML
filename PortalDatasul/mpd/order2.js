...
// Text
// <input class="form-control ng-valid ng-dirty ng-valid-parse ng-touched" bind="" type="text" ng-model="controller.order['nr-pedrep']" ng-disabled="controller.orderDisabled" name="controller_order[nr-pedrep]" id="controller_order[nr-pedrep]">

// Textarea
// <textarea class="form-control ng-pristine ng-valid ng-touched" bind="" rows="3" ng-model="controller.order.observacoes" ng-disabled="controller.orderDisabled" name="controller_order.observacoes" id="controller_order.observacoes"></textarea>
